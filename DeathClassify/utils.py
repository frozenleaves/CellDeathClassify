...
class JsonParser(object):
    ...
    def getCoordinates(self, key):
        ...
        for i in regions:
            try:
                coords.append((i['shape_attributes']['all_points_x'], i['shape_attributes']['all_points_y']))
            except:
                print(i['shape_attributes'].keys())
...
if __name__ == '__main__':
    d3 = DataGenerator(r'C:\Users\wjq\Desktop\json-文件和图象\01\tif\mcy',
                       r"C:\Users\wjq\Desktop\json-文件和图象\01\15M-modify.json",
                       train_data_dic=r'C:\Users\wjq\Desktop\json-文件和图象\01\tif\dic')
    x = d3.generate()
    for i in x:
        print(i)
    # 没有在跑，代码整理通了，数据集还需要组织，等我明天再弄 8.6
